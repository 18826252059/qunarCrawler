...
//        @Grab(group = 'javax.mail', module = 'mail', version = '1.4'),//need to run in Linux
//        @Grab(group = 'org.apache.poi', module = 'poi', version = '3.9'),//need to run in Linux
...
String[] importFileList = ['25_HSSF.xls'];
...
if (afterTitle.equals(beforeTitle)){
    WebElement webElement = driver.findElement(By.id("errmsg"));
    System.out.println("webElement=" + webElement);

    WebElement webElement2 = webElement.findElement(By.cssSelector("span:nth-child(2)"));
    System.out.println("webElement2=" + webElement2);

    String errorMessage = webElement2.getText();
    ...
    try {
        for (int i = startRow; i <= sheet.getLastRowNum(); i++) {
            try {
                ...
                HSSFCell ttiCodeCell = row.getCell(0);
                HSSFCell urlCell = row.getCell(urlRow);
